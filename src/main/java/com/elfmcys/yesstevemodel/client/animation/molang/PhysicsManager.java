...
public class PhysicsManager {
    ...
    public void update(float renderTicks) {
        ...
        } else { lastRenderTicks = renderTicks; }
    }
    public void put(int key, IPhysics physics) { this.physicsValues.put(key, physics); }
    @Nullable public IPhysics get(int key) { return this.physicsValues.get(key); }
    public void clear() { this.lastRenderTicks = 0.0f; this.physicsValues.clear(); }
}