...
public class ConditionPassenger {
    ...
    private static final String ID_PREFIX = "passenger$";
    private static final String TAG_PREFIX = "passenger#";
    ...
    public String doTest(LivingEntity entity) {
        ...
        Entity passenger = passengers.isEmpty() ? null : passengers.get(0);
        return passenger == null || !passenger.isAlive() ? EMPTY : doTest(passenger);
    }
