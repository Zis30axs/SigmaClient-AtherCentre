...
public class ModelAssemblyFactory {
    ...
    public static PlayerModelBundle buildPlayerModelBundle(ClientModelInfo clientModelInfo, ModelResourceBundle resourceBundle, boolean isPrimary, List<Texture> textureList) {
    ...
    private static Map<ResourceLocation, ProjectileModelBundle> buildProjectileModels(ClientModelInfo clientModelInfo, ModelResourceBundle resourceBundle, boolean isPrimary, List<Texture> textureList) {
    ...
    private static Map<ResourceLocation, VehicleModelBundle> buildVehicleModels(ClientModelInfo clientModelInfo, ModelResourceBundle resourceBundle, boolean isPrimary, List<Texture> textureList) {
    ...
    private static ModelDisplayAssets buildTextureRegistry(ClientModelInfo clientModelInfo, boolean isAuth, List<Texture> textureList) {
        Map<String, Texture> extraTextures = extractExtraTextures(clientModelInfo, textureList);
    ...
    public static Map<String, Texture> extractExtraTextures(ClientModelInfo clientModelInfo, List<Texture> textureList) {
        Object2ObjectOpenHashMap<String, Texture> extraTextures = new Object2ObjectOpenHashMap();
