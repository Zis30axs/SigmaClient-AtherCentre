...
public class GeckoVehicleEntity extends GeoEntity<Entity> {
    ...
    public GeoEntity.ModelWrapper buildRenderShape(ModelAssembly modelAssembly, boolean z) {
        VehicleModelBundle modelBundle = modelAssembly.getVehicleModels().get(Registry.ENTITY_TYPE.getKey(this.entity.getType()));
        if (modelBundle != null) {
    ...
    public void onModelLoaded(ModelAssembly modelAssembly) {
        ...
        this.vehicleModel = modelAssembly.getVehicleModels().get(Registry.ENTITY_TYPE.getKey(this.entity.getType()));
    }
    ...
    public ResourceLocation getTextureLocation() {
        return ((EntityModelWrapper) getRenderShape()).textureLocatable.getResourceLocation().orElse(new ResourceLocation("missingno"));
    }
