...
/**
 * Upstream {@code audio/ObjectPool} (verbatim): pools {@link NativeAudioDecoder} instances and
 * destroys the ones idle for more than 200 client ticks. {@link #cleanup()} is called from
 * {@code ClientTickEvent.onClientTick} (wired in W5).
 */
