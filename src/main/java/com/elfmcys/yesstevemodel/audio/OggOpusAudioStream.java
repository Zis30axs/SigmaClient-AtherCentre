...
/**
 * Upstream {@code audio/OggOpusAudioStream} (verbatim modulo the MCP stream method names):
 * decodes OGG/Opus through the pooled {@link NativeAudioDecoder} into 48 kHz mono PCM.
 */
