...
/**
 * Upstream {@code audio/AudioTrackData} (verbatim). OPUS data is copied into a direct buffer
 * because {@code NativeAudioDecoder#openStream} requires direct input; VORBIS data is copied
 * into a heap buffer.
 */
