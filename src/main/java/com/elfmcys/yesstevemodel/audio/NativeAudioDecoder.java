...
/**
 * Upstream {@code audio/NativeAudioDecoder} (verbatim). Despite the name it is pure Java:
 * gagravarr parses the OGG/Opus container and the vendored Concentus sources
 * ({@code org.concentus}) decode the Opus packets to 48 kHz 16-bit PCM, down-mixed to mono
 * (the sound format this port feeds to the engine is mono).
 */
