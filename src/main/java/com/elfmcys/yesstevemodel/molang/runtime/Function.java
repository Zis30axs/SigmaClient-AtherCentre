    ...
    class ArgumentCollection {
        ...
        public ResourceLocation getResourceLocation(@NotNull ExecutionContext<? extends IContext<?>> ctx, final int index) {
            ...
            if (obj2 instanceof StringExpression stringExpression) {
                ...
                ResourceLocation resourceLocationTryParse = ResourceLocation.tryCreate(stringExpression.getName());
                ...
                ResourceLocation resourceLocationTryParse2 = ResourceLocation.tryCreate(str);
