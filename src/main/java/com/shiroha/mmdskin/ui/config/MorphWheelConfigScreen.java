...
public class MorphWheelConfigScreen extends Screen {
    ...
    public MorphWheelConfigScreen(Screen parent) {
        super(new TranslationTextComponent("gui.mmdskin.morph_config"));
        this.parent = parent;
        reloadState();
    }
    ...
    private void renderScreen(MatrixStack guiGraphics) {
        ...
        drawColumn(guiGraphics, layout.availableColumn, layout.availableList,
                new TranslationTextComponent("gui.mmdskin.morph_config.available").getString(),
        ...
        drawColumn(guiGraphics, layout.selectedColumn, layout.selectedList,
                new TranslationTextComponent("gui.mmdskin.morph_config.selected").getString(),
    ...
    private void drawEntryCard(MatrixStack guiGraphics, UiRect listRect, int y,
        ...
        this.font.drawString(guiGraphics, buildMorphTitle(entry), x + 8, y + 4, TranslucentTrayChrome.BODY_TEXT);
        this.font.drawString(guiGraphics, buildMorphMeta(entry), x + 8, y + 15, TranslucentTrayChrome.DETAIL_TEXT);
    }
