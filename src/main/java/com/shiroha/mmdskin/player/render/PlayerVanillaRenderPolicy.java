...
final class PlayerVanillaRenderPolicy {
    ...
    static PlayerRenderAction resolveTerminalAction(PlayerRenderRequest request) {
        ...
        boolean isLocalFirstPerson = request.localPlayer() && minecraft.gameSettings.getPointOfView() == net.minecraft.client.settings.PointOfView.FIRST_PERSON;
    ...
    private static boolean shouldUseVanillaRenderer(String selectedModel, net.minecraft.client.entity.player.AbstractClientPlayerEntity player) {
