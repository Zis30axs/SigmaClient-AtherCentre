...
public final class SceneModelManager {
    ...
    public void placeScene(String folderName) {
        ...
        placeX = minecraft.player.getPosX();
        placeY = minecraft.player.getPosY();
        placeZ = minecraft.player.getPosZ();
        placeYaw = minecraft.player.rotationYaw;
    ...
    public void renderScene(MatrixStack poseStack,
                            float tickDelta,
                            int packedLight,
