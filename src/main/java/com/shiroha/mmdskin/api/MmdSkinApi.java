...
public final class MmdSkinApi {
    ...
    public static ModelInfo getModelInfo(PlayerEntity player) {
        long handle = resolveModelHandle(player);
        return readModelInfo(handle, modelQueryPort);
    }

    public static boolean setBoneOverride(PlayerEntity player, int boneIndex,
    ...
    public static boolean setBoneOverrideByName(PlayerEntity player, String boneName,
                                                float tx, float ty, float tz,
                                                float qx, float qy, float qz, float qw) {
        long handle = resolveModelHandle(player);
    ...
    public static void clearBoneOverrides(PlayerEntity player) {
        long handle = resolveModelHandle(player);
        if (handle != 0) {
    ...
    public static int setBoneOverrideBatch(PlayerEntity player, int[] boneIndices, float[] transforms) {
        long handle = resolveModelHandle(player);
    ...
    public static void setExternalIkOverride(PlayerEntity player, String ikName, boolean enabled) {
        long handle = resolveModelHandle(player);
    ...
    public static void clearExternalIkOverrides(PlayerEntity player) {
        long handle = resolveModelHandle(player);
        if (handle != 0) {
    ...
    public static float[] getUV(PlayerEntity player) {
        long handle = resolveModelHandle(player);
    ...
    private static long resolveModelHandle(PlayerEntity player) {
