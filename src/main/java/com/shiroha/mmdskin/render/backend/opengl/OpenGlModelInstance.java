...
public class OpenGlModelInstance extends BaseModelInstance {
    ...
    void updateLocation(int shaderProgram) {
        ...
        positionLocation = GlStateManager.getAttribLocation(shaderProgram, "Position");
        normalLocation = GlStateManager.getAttribLocation(shaderProgram, "Normal");
        uv0Location = GlStateManager.getAttribLocation(shaderProgram, "UV0");
        uv1Location = GlStateManager.getAttribLocation(shaderProgram, "UV1");
        uv2Location = GlStateManager.getAttribLocation(shaderProgram, "UV2");
        colorLocation = GlStateManager.getAttribLocation(shaderProgram, "Color");
        projMatLocation = GlStateManager.getUniformLocation(shaderProgram, "ProjMat");
        modelViewLocation = GlStateManager.getUniformLocation(shaderProgram, "ModelViewMat");
        sampler0Location = GlStateManager.getUniformLocation(shaderProgram, "Sampler0");
        sampler1Location = GlStateManager.getUniformLocation(shaderProgram, "Sampler1");
        sampler2Location = GlStateManager.getUniformLocation(shaderProgram, "Sampler2");
        light0Location = GlStateManager.getUniformLocation(shaderProgram, "Light0_Direction");
        light1Location = GlStateManager.getUniformLocation(shaderProgram, "Light1_Direction");

        K_positionLocation = GlStateManager.getAttribLocation(shaderProgram, "K_Position");
        K_normalLocation = GlStateManager.getAttribLocation(shaderProgram, "K_Normal");
        K_uv0Location = GlStateManager.getAttribLocation(shaderProgram, "K_UV0");
        K_uv2Location = GlStateManager.getAttribLocation(shaderProgram, "K_UV2");
        K_projMatLocation = GlStateManager.getUniformLocation(shaderProgram, "K_ProjMat");
        K_modelViewLocation = GlStateManager.getUniformLocation(shaderProgram, "K_ModelViewMat");
        K_sampler0Location = GlStateManager.getUniformLocation(shaderProgram, "K_Sampler0");
        K_sampler2Location = GlStateManager.getUniformLocation(shaderProgram, "K_Sampler2");
        KAIMyLocationV = GlStateManager.getUniformLocation(shaderProgram, "MMDShaderV");
        KAIMyLocationF = GlStateManager.getUniformLocation(shaderProgram, "MMDShaderF");

        I_positionLocation = GlStateManager.getAttribLocation(shaderProgram, "iris_Position");
        I_normalLocation = GlStateManager.getAttribLocation(shaderProgram, "iris_Normal");
        I_uv0Location = GlStateManager.getAttribLocation(shaderProgram, "iris_UV0");
        I_uv2Location = GlStateManager.getAttribLocation(shaderProgram, "iris_UV2");
        I_colorLocation = GlStateManager.getAttribLocation(shaderProgram, "iris_Color");
    }
