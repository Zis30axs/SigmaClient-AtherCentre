...
public class GpuSkinningModelInstance extends BaseModelInstance {
    ...
    MatrixStack currentDeliverStack;
    ...
    void updateLocation(int program) {
        ...
        positionLocation = GlStateManager.getAttribLocation(program, "Position");
        normalLocation = GlStateManager.getAttribLocation(program, "Normal");
        uv0Location = GlStateManager.getAttribLocation(program, "UV0");
        uv1Location = GlStateManager.getAttribLocation(program, "UV1");
        uv2Location = GlStateManager.getAttribLocation(program, "UV2");
        colorLocation = GlStateManager.getAttribLocation(program, "Color");

        I_positionLocation = GlStateManager.getAttribLocation(program, "iris_Position");
        I_normalLocation = GlStateManager.getAttribLocation(program, "iris_Normal");
        I_uv0Location = GlStateManager.getAttribLocation(program, "iris_UV0");
        I_uv2Location = GlStateManager.getAttribLocation(program, "iris_UV2");
        I_colorLocation = GlStateManager.getAttribLocation(program, "iris_Color");
    }
